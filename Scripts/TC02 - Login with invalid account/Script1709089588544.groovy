...
WebUI.verifyElementPresent(findTestObject('Page_ACME Demo App by Applitools/img'), 1, FailureHandling.OPTIONAL)

WebUI.verifyElementPresent(findTestObject('Page_ACME Demo App by Applitools/h4_Login Form'), 1, FailureHandling.OPTIONAL)
